...
% Build with pdfLaTeX through build.sh; pnureport.cls is copied unchanged from report_ko.
\documentclass{pnureport}
% Preserve text extraction for Latin ranges and punctuation.
\usepackage{cmap}
\usepackage[T1]{fontenc}
\usepackage{booktabs,longtable,array,tabularx,amssymb}
\usepackage{graphicx,subcaption,placeins,needspace}
...
\raggedbottom
% Keep short paragraph fragments off otherwise empty pages.
\clubpenalty=10000
\widowpenalty=10000
...
\begingroup
\raggedright
% Keep each bibliography entry together across page breaks.

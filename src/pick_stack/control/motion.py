...
from pick_stack.control.poses import Pose, PoseRegistry
from pick_stack.control.robot_io import BaseRobotIO
from pick_stack.control.sensing import ContactMonitor
from pick_stack.control.trajectory import TrajectoryPlayer, interpolate
...
class MotionController:
    ...
    def validate_poses(self, *, task: int) -> None:

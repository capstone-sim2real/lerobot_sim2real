...
from pick_stack.perception.homography import (
    PlaneCalibration,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--out", default=None, help="default: src/pick_stack/configs/calib/<venue>.json")
    ...
    out = Path(args.out) if args.out else Path(f"src/pick_stack/configs/calib/{args.venue}.json")
    calib.save(out)
